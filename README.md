...
- **Native ggml ops** — default `ggml_conv_transpose_1d` upsample (accurate); optional sub-pixel `ggml_conv_1d` + graph interleave (experimental), `ggml_mul_mat` for the source conv
